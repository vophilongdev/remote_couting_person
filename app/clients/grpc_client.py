# -*- coding: utf-8 -*-
"""
gRPC Client — Outbound Adapter for Remote Frame Object Detection Service
...
try:
    from app.clients.grpc_services import services_pb2, services_pb2_grpc
except ImportError:
    try:
        from clients.grpc_services import services_pb2, services_pb2_grpc
    except ImportError:
